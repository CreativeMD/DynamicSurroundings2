...
public abstract class Scanner {
    ...
    public Scanner(@Nonnull final ScanContext locus, @Nonnull final String name, final int range, final int blocksPerTick) {
        this(locus, name, range, range, range, blocksPerTick);
    }
    
    public Scanner(@Nonnull final ScanContext locus, @Nonnull final String name, final int xRange, final int yRange, final int zRange) {
        this(locus, name, xRange, yRange, zRange, 0);
    }
    
    public Scanner(@Nonnull final ScanContext locus, @Nonnull final String name, final int xRange, final int yRange, final int zRange, final int blocksPerTick) {
        this.name = name;
        this.xRange = xRange;
        this.yRange = yRange;
        this.zRange = zRange;
     ...
     * copied. */
    public abstract void blockScan(@Nonnull final BlockState state, @Nonnull final BlockPos pos, @Nonnull final Random rand);
