...
public abstract class CuboidScanner extends Scanner {
    ...
    protected CuboidScanner(@Nonnull final ScanContext locus, @Nonnull final String name, final int range, final int blocksPerTick) {
        super(locus, name, range, blocksPerTick);
    }
    
    protected CuboidScanner(@Nonnull final ScanContext locus, @Nonnull final String name, final int xRange, final int yRange, final int zRange) {
        super(locus, name, xRange, yRange, zRange);
    }
    
    protected CuboidScanner(@Nonnull final ScanContext locus, @Nonnull final String name, final int xSize, final int ySize, final int zSize, final int blocksPerTick) {
