...
public abstract class BlockEffect {
    ...
    public abstract void doEffect(@Nonnull final IBlockReader provider, @Nonnull final BlockState state, @Nonnull final BlockPos pos, @Nonnull final Random random);
    
    @Override
    @Nonnull
    public String toString() {
        return "type: " + getEffectType().getName() + " conditions: [" + getConditions() + ']' + "; chance:" + getChance() + ' ' + this.getClass().getSimpleName();
    }
}