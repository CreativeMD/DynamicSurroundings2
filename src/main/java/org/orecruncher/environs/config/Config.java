...
public final class Config {
    ...
    private static final String CLIENT_CONFIG = DynamicSurroundings.MODID + File.separator + Environs.MOD_ID + "-client.toml";
    ...
    public static class Client {
        ...
        public static class Logging {
            ...
            Logging(@Nonnull final ForgeConfigSpec.Builder builder) {
                ...
                this.flagMask = builder.comment("Bitmask for toggling various debug traces").translation("environs.cfg.logging.FlagMask")
        ...
        public static class Biome {
            ...
            Biome(@Nonnull final ForgeConfigSpec.Builder builder) {
                ...
                this.worldSealevelOverride = builder.comment("Sealevel to set for Overworld (0 use default for World)").translation("environs.cfg.biomes.Sealevel")
                        .defineInRange("Overworld Sealevel Override", 0, 0, 256);
                
                this.biomeSoundBlacklist = builder.comment("Dimension IDs where biome sounds will not be played").translation("environs.cfg.biomes.DimBlacklist")
        ...
        public static class Effects {
            ...
            Effects(@Nonnull final ForgeConfigSpec.Builder builder) {
                ...
                this.enableFireFlies = builder.worldRestart().comment("Enable/disable Firefly effect around plants").translation("environs.cfg.effects.Fireflies")
                        .define("Fireflies", true);
                
                this.enableSteamJets = builder.worldRestart().comment("Enable/disable Steam Jets where lava meets water").translation("environs.cfg.effects.Steam")
                ...
                this.enableBubbleJets = builder.worldRestart().comment("Enable/disable Bubble Jets under water").translation("environs.cfg.effects.Bubble")
                        .define("Bubble Jets", true);
                
                this.enableDustJets = builder.worldRestart().comment("Enable/disable Dust Motes dropping from under blocks").translation("environs.cfg.effects.Dust")
                        .define("Dust Jets", true);
                
                this.enableFountainJets = builder.worldRestart().comment("Enable/disable Fountain Jets spraying").translation("environs.cfg.effects.Fountain")
                        .define("Fountain Jets", true);
                
                this.enableWaterfalls = builder.worldRestart().comment("Enable/disable Water Splash effects when water spills down").translation("environs.cfg.effects.Splash")
                        .define("Waterfall Splash", true);
                
                this.waterfallCutoff = builder.comment("Limit sounds to waterfall strengths above this value").translation("environs.cfg.effects.WaterfallCutoff")
                        .defineInRange("Waterfall Strength Cutoff", 0, 0, JetEffect.MAX_STRENGTH);
                
                this.disableUnderwaterParticles = builder.worldRestart().comment("Enable/disable Minecraft's Underwater particle effect")
                        .translation("environs.cfg.effects.Underwater").define("Disable Underwater Particles", false);
                
                this.enableWaterRipples = builder.comment("Enable/disable Water Ripple effects for rain and water splash").translation("environs.cfg.effects.WaterRipple")
                        .define("Water Ripples", true);
                
                // The default validator chokes on this enum for some reason
                this.waterRippleStyle = builder.comment("The render style of water ripples").translation("environs.cfg.effects.WaterRippleStyle")
        ...
        public static class Fog {
            ...
            Fog(@Nonnull final ForgeConfigSpec.Builder builder) {
                ...
                this.enableElevationHaze = builder.comment("Higher the player elevation the more haze that is experienced").translation("environs.cfg.fog.Haze")
                ...
                this.morningFogChance = builder.comment("Percentage chance morning fog will occur").translation("environs.cfg.fog.MorningChance")
        ...
        public static class Sound {
            ...
            Sound(@Nonnull final ForgeConfigSpec.Builder builder) {
                ...
                this.biomeSoundVolume = builder.comment("Scaling factor to apply to biome sounds").translation("environs.cfg.sound.BiomeVolume")
                        .defineInRange("Biome Sound Volume", 100, 0, 100);
                
                this.spotSoundVolume = builder.comment("Scaling factor to apply to spot sounds").translation("environs.cfg.sound.SpotVolume")
                        .defineInRange("Spot Sound Volume", 100, 0, 100);
                
                this.waterfallSoundVolume = builder.comment("Scaling factor to apply to waterfall sounds").translation("environs.cfg.sound.WaterfallVolume")
