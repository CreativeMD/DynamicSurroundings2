...
public class FootprintMote extends AgeableMote {
    ...
    public FootprintMote(@Nonnull final FootprintStyle style, @Nonnull final IBlockReader world, final double x, final double y, final double z, final float rotation, final float scale, final boolean isRight) {
        super(world, x, y, z);
