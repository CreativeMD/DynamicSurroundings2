    ...
    public static class Client {
        ...
        public static class Logging {
            ...
            Logging(@Nonnull final ForgeConfigSpec.Builder builder) {
                ...
                this.flagMask = builder.comment("Bitmask for toggling various debug traces").translation("mobeffects.cfg.logging.FlagMask")
        ...
        public static class Footsteps {
            ...
            public Footsteps(@Nonnull final ForgeConfigSpec.Builder builder) {
                ...
                this.enableFootstepSounds = builder.comment("Enable replacement of footstep sounds with acoustic versions").translation("mobeffects.cfg.footsteps.SoundEnable")
                        .define("Enable Footprint Sound Effects", true);
                
                this.enableFootprintParticles = builder.comment("Enable Footprint particle effects").translation("mobeffects.cfg.footsteps.Enable")
                        .define("Enable Footprint Particles", true);
                
                this.firstPersonFootstepCadence = builder.comment("Use first person footstep cadence").translation("mobeffects.cfg.footsteps.Cadence")
                        .define("First Person Cadence", true);
                
                this.playerFootprintStyle = builder.comment("Style of footprint to display for a player").translation("mobeffects.cfg.footsteps.PlayerStyle")
                        .defineEnum("Player Footprint Style", FootprintStyle.LOWRES_SQUARE);
                
                this.footstepsAsQuadruped = builder.comment("Generate footsteps as a quadruped (horse)").translation("mobeffects.cfg.footsteps.Quadruped")
                        .define("Footsteps as Quadruped", false);
                
                this.footstepVolume = builder.comment("Footstep master volume scale").translation("mobeffects.cfg.footsteps.Volume")
                        .defineInRange("Footstep Volume Scale", FOOTSTEP_VOLUME_DEFAULT, 0, 100);
                
                this.enableArmorAccents = builder.comment("Enable armor rustle accents for footstep acoustics").translation("mobeffects.cfg.footsteps.ArmorAccents")
                        .define("Enable Armor Accents", true);
                
                this.enableRainSplashAccent = builder.comment("Enable rain splash accents for footstep acoustics").translation("mobeffects.cfg.footsteps.RainSplashAccents")
                        .define("Enable Rain Splash Accents", true);
                
                this.enableWaterLoggedAccent = builder.comment("Enable water logged accents for footstep acoustics").translation("mobeffects.cfg.footsteps.WaterLoggedAccents")
        ...
        public static class Effects {
            ...
            public Effects(@Nonnull final ForgeConfigSpec.Builder builder) {
                ...
                this.hidePlayerPotionParticles = builder.comment("Hides the player's potion particles to avoid cluttering display")
                        .translation("mobeffects.cfg.effects.PotionParticles").define("Hide Player Potion Particles", true);
                
                this.showBreath = builder.worldRestart().comment("Show breath effect in cold regions and underwater").translation("mobeffects.cfg.effects.Breath")
                        .define("Show Breath Effect", true);
                
                this.showArrowTrail = builder.comment("Show arrow particle trail during flight").translation("mobeffects.cfg.effects.Arrow")
                        .define("Show Arrow Particle Trail", false);
                
                this.enableToolbarEffect = builder.worldRestart().comment("Enable toolbar item sound effects").translation("mobeffects.cfg.effects.Toolbar")
                        .define("Enable Toolbar Sound Effects", true);
                
                this.enableBowEffect = builder.worldRestart().comment("Enable bow/crossbow sound effects").translation("mobeffects.cfg.effects.Bow")
                        .define("Enable Bow Sound Effects", true);
                
                this.enableSwingEffect = builder.worldRestart().comment("Enable item swing sound effects").translation("mobeffects.cfg.effects.Swing")
                        .define("Enable Item Swing Sound Effects", true);
                
                this.toolbarVolume = builder.comment("Toolbar master volume scale").translation("mobeffects.cfg.effects.ToolbarVolume")
