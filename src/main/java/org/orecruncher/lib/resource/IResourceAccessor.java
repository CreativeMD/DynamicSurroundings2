...
public interface IResourceAccessor {
     ...
     *
     * @param clazz
     *            Class of the object to deserialize
     * @param <T>
     *            The type of object that is being deserialized
     ...
     * 
     * @param type
     *            Type of object instance to deserialize
     * @param <T>
     *            The object type for casting
     * @return Reference to the deserialized object, null if not possible */
     ...
     *
     * @param rootContainer
     *            The location within the asset folder where data can be found. Typically it's the mod ID.
     * @param location
     *            The resource location of the data that needs to be retrieved.
     ...
     *
     * @param root
     *            The location on disk where the data can be found.
     * @param location
     *            The resource location of the data that needs to be retrieved.
     * @return Reference to a resource accessor to obtain the necessary data. */
     ...
     * 
     * @param pack
     *            Resource pack containing the needed resource data
     * @param location
     *            Location of the resource within the pack
     * @return Reference to a resource accessor to obtain the necessary data. */
     ...
     * 
     * @param accessors
     *            Collection of accessors to invoke
     * @param consumer
     *            The routine to invoke on each accessor. */
