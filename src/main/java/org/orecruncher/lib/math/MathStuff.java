...
public final class MathStuff {
     ...
     * 
     * @param base
     *            Base to add another scaled vector to
     * @param addened
     *            Vector to scale and add to the base
     * @param scale
     *            Scale to apply to the addened vector before adding to the base
     ...
     *            Origin point
     * @param target
     *            Point where the normal will point
