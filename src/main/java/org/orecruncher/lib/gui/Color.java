...
public class Color {
    ...
    public static Color parse(@Nonnull final String input) {
        ...
        return new Color(MathStuff.clamp(parts[0], 0, 255), MathStuff.clamp(parts[1], 0, 255), MathStuff.clamp(parts[2], 0, 255));
    }
    ...
    public Color blend(@Nonnull final Color color, final float factor) {
        return new Color(blnd(this.red, color.red, factor), blnd(this.green, color.green, factor), blnd(this.blue, color.blue, factor), this.alpha);
    }
    ...
    public String toString() {
        return "[r:" + (int) (this.red * 255) + ",g:" + (int) (this.green * 255) + ",b:" + (int) (this.blue * 255) + ",a:" + (int) (this.alpha * 255) + ']';
    }
