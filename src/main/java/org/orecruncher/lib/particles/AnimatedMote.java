...
public abstract class AnimatedMote extends MotionMote {
    ...
    protected AnimatedMote(final @Nonnull IAnimatedSprite sprites, @Nonnull final IBlockReader world, double x, double y, double z, double dX, double dY, double dZ) {
