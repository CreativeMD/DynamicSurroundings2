    ...
    public void apply(@Nonnull final ReverbData data, @Nonnull final AuxSlot aux) {
        if (isInitialized()) {
            if (data.doProcess()) {
                ...
                execute(() -> EXTEfx
                        .alEffectf(getSlot(), EXTEfx.AL_EAXREVERB_REFLECTIONS_GAIN, data.reflectionsGain), () -> "ReverbEffectSlot EXTEfx.AL_EFFECTSLOT_EFFECT reflectionsGain");
                execute(() -> EXTEfx
                        .alEffectf(getSlot(), EXTEfx.AL_EAXREVERB_REFLECTIONS_DELAY, data.reflectionsDelay), () -> "ReverbEffectSlot EXTEfx.AL_EFFECTSLOT_EFFECT reflectionsDelay");
                execute(() -> EXTEfx
                        .alEffectf(getSlot(), EXTEfx.AL_EAXREVERB_LATE_REVERB_GAIN, data.lateReverbGain), () -> "ReverbEffectSlot EXTEfx.AL_EFFECTSLOT_EFFECT lateReverbGain");
                execute(() -> EXTEfx
                        .alEffectf(getSlot(), EXTEfx.AL_EAXREVERB_LATE_REVERB_DELAY, data.lateReverbDelay), () -> "ReverbEffectSlot EXTEfx.AL_EFFECTSLOT_EFFECT lateReverbDelay");
                execute(() -> EXTEfx
                        .alEffectf(getSlot(), EXTEfx.AL_EAXREVERB_AIR_ABSORPTION_GAINHF, data.airAbsorptionGainHF), () -> "ReverbEffectSlot EXTEfx.AL_EFFECTSLOT_EFFECT airAbsorptionGainHF");
                execute(() -> EXTEfx
                        .alEffectf(getSlot(), EXTEfx.AL_EAXREVERB_ROOM_ROLLOFF_FACTOR, data.roomRolloffFactor), () -> "ReverbEffectSlot EXTEfx.AL_EFFECTSLOT_EFFECT roomRolloffFactor");
                ...
                execute(() -> EXTEfx
                        .alAuxiliaryEffectSloti(aux.getSlot(), EXTEfx.AL_EFFECTSLOT_EFFECT, EXTEfx.AL_EFFECTSLOT_NULL), () -> "ReverbEffectSlot EXTEfx.AL_EFFECTSLOT_EFFECT null");
            }
        }
    }
}
