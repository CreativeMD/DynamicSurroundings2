...
public class SoundInstance extends LocatableSound implements ISoundInstance {
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this).addValue(getSoundLocation().toString()).addValue(getSoundCategory().toString()).addValue(getAttenuationType().toString())
                .addValue(getState().toString()).add("v", getVolume()).add("ev", getEffectiveVolume(this)).add("p", getPitch()).add("x", getX()).add("y", getY()).add("z", getZ())
                .toString();
    }
