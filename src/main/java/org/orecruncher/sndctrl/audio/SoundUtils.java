...
public final class SoundUtils {
     ...
     *
     * @param sound
     *            Sound instance to check for a volume block
     ...
     * @param sound
     *            The sound that is to be evaluated
     * @param pad
     *            Additional distance to add when evaluating
     ...
     *
     * @param sound
     *            Sound instance to provide a debug string for
     * @return Debug string */
    @Nonnull
    public static String debugString(@Nullable final ISound sound) {
        ...
        //@formatter:off
        return MoreObjects.toStringHelper(sound).addValue(sound.getSoundLocation().toString()).addValue(sound.getCategory().toString())
                .addValue(sound.getAttenuationType().toString()).add("v", sound.getVolume()).add("p", sound.getPitch()).add("x", sound.getX()).add("y", sound.getY())
                .add("z", sound.getZ()).add("distance", sound.getSound().getAttenuationDistance()).add("streaming", sound.getSound().isStreaming()).add("global", sound.isGlobal())
                .toString();
        //@formatter:on
    }
     ...
     *
     * @param soundSystem
     *            The sound system instance being initialized */
