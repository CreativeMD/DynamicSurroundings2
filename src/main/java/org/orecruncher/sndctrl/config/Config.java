...
public final class Config {
    ...
    public static class Client {
        ...
        public static final List<String> defaultSoundConfig = ImmutableList.<String>builder().add("minecraft:entity.sheep.ambient cull")
                .add("minecraft:entity.chicken.ambient cull").add("minecraft:entity.cow.ambient cull").add("minecraft:entity.pig.ambient cull")
                .add("minecraft:entity.llama.ambient cull").add("minecraft:entity.wither.spawn cull 10").add("minecraft:entity.wither.death cull 10")
                .add("minecraft:entity.ender_dragon.death cull 10").build();
        
        public static final List<String> defaultStartupSounds = ImmutableList.<String>builder().add("minecraft:entity.experience_orb.pickup").add("minecraft:entity.chicken.egg")
                .add("minecraft:ambient.underwater.exit").build();
        ...
        public static class Sound {
            ...
            Sound(@Nonnull final ForgeConfigSpec.Builder builder) {
                ...
                this.enableEnhancedSounds = builder.worldRestart().comment("Enable sound reverb and filtering").translation("sndctrl.cfg.sound.EnhancedSounds")
                        .define("Enable Enhanced Sounds", true);
                
                this.enableHRTF = builder.worldRestart().comment("Enable HRTF processing in OpenAL").translation("sndctrl.cfg.sound.EnhancedHRTF")
                        .define("Enable HRTF Processing", false);
                
                this.enableMonoConversion = builder.comment("Enable conversion of stereo sounds to mono format for spacial play").translation("sndctrl.cfg.sound.MonoConversion")
                        .define("Enable Stereo to Mono Conversion", true);
                
                this.enableOcclusionCalcs = builder.comment("Enable sound occlusion calculations (sound muffling when positioned behind blocks)")
                        .translation("sndctrl.cfg.sound.Occlusion").define("Enable Sound Occlusion Calculations", true);
                
                this.streamingSoundCount = builder.worldRestart().comment("Number of streaming sound channels to configure").translation("sndctrl.cfg.sound.StreamingSoundCount")
                ...
                this.individualSounds = builder.comment("Options to configure sounds on an individual basis").translation("sndctrl.cfg.sound.Individual")
                        .defineList("Individual Sound Config", defaultSoundConfig, s -> true);
                
                this.startupSoundList = builder.comment("Possible sounds to play when client reaches main game menu").translation("sndctrl.cfg.sound.StartupSounds")
                        .defineList("Startup Sound List", defaultStartupSounds, s -> true);
                
                this.cullInterval = builder.comment("Ticks between culled sound events (0 to disable culling)").translation("sndctrl.cfg.sound.CullInterval")
                        .defineInRange("Sound Culling Interval", 20, 0, 6000);
                
                this.backgroundThreadWorkers = builder.worldRestart().comment("Number of background threads to handle sound effect calculations (0 is default)")
                        .translation("sndctrl.cfg.sound.Threads").defineInRange("Background Workers", 0, 0, 8);
        ...
        public static class Effects {
            ...
            Effects(@Nonnull final ForgeConfigSpec.Builder builder) {
                ...
                this.fixupRandoms = builder.worldRestart().comment("Replace client side Randomizers with faster versions").translation("sndctrl.cfg.effects.Randoms")
                        .define("Replace Randoms", true);
                
                this.effectRange = builder.worldRestart().comment("Block range of entity special effect handling").translation("sndctrl.cfg.effects.BlockRange")
        ...
        public static class Logging {
            ...
            Logging(@Nonnull final ForgeConfigSpec.Builder builder) {
                ...
                this.flagMask = builder.comment("Bitmask for toggling various debug traces").translation("sndctrl.cfg.logging.FlagMask")
