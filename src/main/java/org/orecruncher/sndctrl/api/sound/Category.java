...
public class Category implements ISoundCategory {
    ...
    public static final ISoundCategory CONFIG = new Category("CONFIG", "sndctrl.soundcategory.config", () -> 1F, (v) -> {}, () -> false) {
        @Override
     ...
     *
     * @param name
     *            Name of the sound category. Needs to be unique.
     * @param translationKey
     *            Language translation key for GUI display
     * @param scale
     *            The supplier that gives the scaling factor to apply for the sound category.
     * @param setter
     *            The consumer that allows configuration of the scale factor */
     ...
     *            The consumer that allows configuration of the scale factor
     * @param occlusion
     *            Supplier that indicates if the category can be occluded */
     ...
     *
     * @param name
     *            The name of the sound category to retrieve
     ...
     *
     * @param sound
     *            The sound for which the category is needed
     ...
     *
     * @param category
     *            The ISoundCategory instance to register */
