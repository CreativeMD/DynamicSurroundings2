...
public class IndividualSoundControlScreen extends Screen {
    ...
    protected void init() {
        ...
        this.searchField = new TextFieldWidget(this.font, searchBarLeftMargin, searchBarY, SEARCH_BAR_WIDTH, SEARCH_BAR_HEIGHT, this.searchField, // Copy existing data over
        ...
        this.soundConfigList = new IndividualSoundControlList(this, GameUtils
                .getMC(), this.width, this.height, topY, bottomY, SELECTION_WIDTH, SELECTION_HEIGHT, this.enablePlay, () -> this.searchField.getText(), this.soundConfigList);
        ...
        this.save = new Button(controlMargin, controlHeight, BUTTON_WIDTH, BUTTON_HEIGHT, SAVE, this::save);
        this.addButton(this.save);
        
        this.cancel = new Button(controlMargin + BUTTON_WIDTH + BUTTON_SPACING, controlHeight, BUTTON_WIDTH, BUTTON_HEIGHT, CANCEL, this::cancel);
